<div>
    <form wire:submit.prevent="submit">
        <div class="grid grid-cols-6 gap-6">
            <x-text-input wire:model="name" label="Name" :required="true" placeholder="Jeffrey Way"
                class="col-span-6 sm:col-span-3" />

            <x-text-input wire:model="email" type="email" label="Email" :required="true"
            ...
            <x-text-input wire:model="title" label="Title" :required="true" placeholder="Instructor"
                class="col-span-6 sm:col-span-3" />
